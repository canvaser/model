package com.mobisoft.library.view.cycleindicatorviewpager;
...
import com.mobisoft.library.view.cycleindicatorviewpager.indicator.PageIndicator;
import com.mobisoft.library.view.cycleindicatorviewpager.indicator.RecyleAdapter;
import com.mobisoft.library.view.cycleindicatorviewpager.jakewharton.salvage.RecyclingPagerAdapter;
import com.mobisoft.library.view.cycleindicatorviewpager.slideview.BaseSliderView;
...
/**
 * Created by lightSky on 2014/12/22. Thanks to: https://github.com/Trinea/android-auto-scroll-view-pager
 */
public class InfiniteIndicatorLayout extends RelativeLayout implements RecyclingPagerAdapter.DataChangeListener {
	...
	/**
	 * set how to process when sliding at the last or first item will be explore in future version
	 * 
	...
	public enum IndicatorPosition {
		Center("Center_Bottom", R.id.default_center_indicator), Center_Bottom("Center_Bottom",
				R.id.default_center_bottom_indicator), Right_Bottom("Right_Bottom",
						R.id.default_bottom_right_indicator), Left_Bottom("Left_Bottom",
								R.id.default_bottom_left_indicator), Center_Top("Center_Top",
										R.id.default_center_top_indicator), Right_Top("Right_Top",
												R.id.default_center_top_right_indicator), Left_Top("Left_Top",
