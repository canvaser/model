package com.mobisoft.library.view.cycleindicatorviewpager.slideview;
...
/**
 * When you want to make your own slider view, you must extends from this class. BaseSliderView provides some useful
 * methods. if you want to show progressbar, you just need to set a progressbar id as @+id/loading_bar.
 *
...
public abstract class BaseSliderView {
	...
	/**
	 * the extended class have to implement getView(), which is called by the adapter, every extended class response to
