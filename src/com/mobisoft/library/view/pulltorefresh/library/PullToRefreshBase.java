...
import com.mobisoft.library.view.pulltorefresh.library.internal.FlipLoadingLayout;
import com.mobisoft.library.view.pulltorefresh.library.internal.LoadingLayout;
import com.mobisoft.library.view.pulltorefresh.library.internal.RotateLoadingLayout;
import com.mobisoft.library.view.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			...
			StringUtil.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
